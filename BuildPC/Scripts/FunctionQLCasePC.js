...
$(document).ready(function () {
    ...
    $.ajax({
        url: 'http://localhost:50895/api/casepc/',
        type: 'GET',
        dataType: 'json',
            ...
            $("button[name='btndel']").click(function () {
                ...
                $.getJSON('/api/casepc/' + this.value, function (val) {
                    ...
                    $("button[name='btndelete']").click(function () {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'http://localhost:50895/api/casepc/delete/' + val.MaCase,
                            contentType: "application/json; charset=utf-8",
                            dataType: 'json',
                            success: function (data) {
...
function Loc() {
    $.ajax({
        url: 'http://localhost:50895/api/casepc/sort/' + document.getElementById("sortMin").value + "/" + document.getElementById("sortMax").value,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            var rowscasepc = '';
...
function Timkiem() {
    $.ajax({
        url: 'http://localhost:50895/api/casepc/search/' + document.getElementById("search").value,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            var rowscasepc = '';
