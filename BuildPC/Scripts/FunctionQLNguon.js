...
$(document).ready(function () {
    ...
    $.ajax({
        url: 'http://localhost:50895/api/nguon/',
        type: 'GET',
        dataType: 'json',
            ...
            $("button[name='btndel']").click(function () {
                ...
                $.getJSON('/api/nguon/' + this.value, function (val) {
                    ...
                    $("button[name='btndelete']").click(function () {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'http://localhost:50895/api/nguon/delete/' + val.MaNguon,
                            contentType: "application/json; charset=utf-8",
                            dataType: 'json',
                            success: function (data) {
...
function Loc() {
    $.ajax({
        url: 'http://localhost:50895/api/nguon/sort/' + document.getElementById("sortMin").value + "/" + document.getElementById("sortMax").value,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            var rowsnguon = '';
...
function Timkiem() {
    $.ajax({
        url: 'http://localhost:50895/api/nguon/search/' + document.getElementById("search").value,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            var rowsnguon = '';
