...
function Update() {
    ...
    else
    {
        ...
        if (check[0] === 0)
        {
            $.ajax({
                type: 'POST',
                url: 'http://localhost:50895/api/calculate/update/' + Giatien + '/' + document.querySelector('input[name="nhucau"]:checked').value,
...
function Check(MaMain, MaRam, MaCPU, MaGPU) {
    ...
    var lstFalse = [];
    $.ajax({
        url: 'http://localhost:50895/api/calculate/checkrm/' + MaRam + '/' + MaMain,
        async: false,
        dataType: 'json',
        success: function (data) {
            Check1 = data;
    ...
    $.ajax({
        url: 'http://localhost:50895/api/calculate/checkgm/' + MaGPU + '/' + MaMain,
        async: false,
        dataType: 'json',
        success: function (data) {
            Check2 = data;
    ...
    $.ajax({
        url: 'http://localhost:50895/api/calculate/checkcm/' + MaCPU + '/' + MaMain,
        async: false,
        dataType: 'json',
        success: function (data) {
            Check3 = data;
    ...
    $.ajax({
        url: 'http://localhost:50895/api/calculate/checkcg/' + MaCPU + '/' + MaGPU,
        async: false,
        dataType: 'json',
        success: function (data) {
            Check4 = data;
