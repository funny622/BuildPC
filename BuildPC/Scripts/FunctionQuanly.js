...
$(document).ready(function () {
    ...
    $.ajax({
        url: 'http://localhost:50895/api/ram/',
        type: 'GET',
        dataType: 'json',
            ...
            $("button[name='btndel']").click(function () {
                ...
                $.getJSON('/api/ram/' + this.value, function (val) {
                    ...
                    $("button[name='btndelete']").click(function () {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'http://localhost:50895/api/ram/delete/' + val.MaRam,
                            contentType: "application/json; charset=utf-8",
                            dataType: 'json',
                            success: function (data) {
...
function Loc() {
                                $.ajax({
                                    url: 'http://localhost:50895/api/ram/sort/' + document.getElementById("sortMin").value + "/" + document.getElementById("sortMax").value,
                                    type: 'GET',
                                    dataType: 'json',
                                    success: function (data) {
                                        var rowsram = '';
...
function Timkiem() {
                                $.ajax({
                                    url: 'http://localhost:50895/api/ram/search/' + document.getElementById("search").value,
                                    type: 'GET',
                                    dataType: 'json',
                                    success: function (data) {
                                        var rowsram = '';
