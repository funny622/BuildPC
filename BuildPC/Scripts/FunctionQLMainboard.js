...
$(document).ready(function () {
    ...
    $.ajax({
        url: 'http://localhost:50895/api/mainboard/',
        type: 'GET',
        dataType: 'json',
            ...
            $("button[name='btndel']").click(function () {
                ...
                $.getJSON('/api/mainboard/' + this.value, function (val) {
                    ...
                    $("button[name='btndelete']").click(function () {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'http://localhost:50895/api/mainboard/delete/' + val.MaMain,
                            contentType: "application/json; charset=utf-8",
                            dataType: 'json',
                            success: function (data) {
...
function Loc() {
    $.ajax({
        url: 'http://localhost:50895/api/mainboard/sort/' + document.getElementById("sortMin").value + "/" + document.getElementById("sortMax").value,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            var rowsmainboard = '';
...
function Timkiem() {
    $.ajax({
        url: 'http://localhost:50895/api/mainboard/search/' + document.getElementById("search").value,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            var rowsmainboard = '';
