    ...
    if (Giatien < GiaCHTT) {
        ...
        $.getJSON(('/api/calculate/' + Giatien + '/' + chon), function (data) {
            $.each(data, function (key, val) {
                ...
                result += '<p>Cấu hình ' + i + ':</p><p>Mainboard:' + Name[2] + '</p><p>GPU:' + Name[0] + '</p><p>CPU:' + Name[1] + '</p><p>Ram:' + Name[3] + '</p><p>HDD:' + Name[5] + '</p><p>Nguồn:' + Name[7] + '</p><p>CasePC:' + Name[8] + '</p><p>Giá bán: ' + Giaban + 'VND</p></br></br>';
