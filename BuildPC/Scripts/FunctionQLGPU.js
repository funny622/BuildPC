...
$(document).ready(function () {
    ...
    $.ajax({
        url: 'http://localhost:50895/api/gpu/',
        type: 'GET',
        dataType: 'json',
            ...
            $("button[name='btndel']").click(function () {
                ...
                $.getJSON('/api/gpu/' + this.value, function (val) {
                    ...
                    $("button[name='btndelete']").click(function () {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'http://localhost:50895/api/gpu/delete/' + val.MaGPU,
                            contentType: "application/json; charset=utf-8",
                            dataType: 'json',
                            success: function (data) {
...
function Loc() {
    $.ajax({
        url: 'http://localhost:50895/api/gpu/sort/' + document.getElementById("sortMin").value + "/" + document.getElementById("sortMax").value,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            var rowsgpu = '';
...
function Timkiem() {
    $.ajax({
        url: 'http://localhost:50895/api/gpu/search/' + document.getElementById("search").value,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            var rowsgpu = '';
